            ...
            $(document).ready(function() { 
                ...
                function SalesByDate() {
                    ...
                    $('#sales_by_date').highcharts({
                        ...
                        subtitle: {
                            text: 'Source <a href="http://fds.thepetronic.com" target="_blank">the petronicspa</a>',
                            x: -20 
                        },
                        xAxis: {
                            cateogories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun',
            ...
            function sales1(){
                petrojs.GET('sales_count.php', function(get) {
                    ...
                    for (var i=0; i <pos.length; i++) {
                        ...
                        this_year = parseInt(pos[i].last_year);
                        var sum1 = ['THIS_MONTH',this_month];
                        data.push(sum1);
                        var sum2 = ['LAST_MONTH', last_month];
                        data.push(sum2);
                        var sum3 = ['THIS_YEAR',this_year];
                        data.push(sum3);
                        var sum4 = ['LAST_YEAR', last_year];
                        data.push(sum4);
                    }
                    $('#sales_chart').highcharts({
                        ...
                        subtitle: {
                            text: 'Source <a href="http://fds.thepetronic.com' target="_blank">The petronics</a>' 
                        },
                        colors: [
                            '#8dc100'
                        ],
                        ...
                        series: [{
                            ...
                            datalabels: {
                                ...
                                color: '#FFFFFF',
                                align: 'right',
                                y: 10, // 10 pixles down from the top 
                                style: {
                                    fontSize: '10px',
                                    fontFamily: 'Verdana, sans-serif'
                                }
            ...
            function sales2(){
                petrojs.GET('user_info_count.php', function(get) {
                    ...
                    $('#sales_chart').highcharts({
                        ...
                        subtitle: {
                            text: 'Source <a href="http://fds.thepetronics.com' target="_blank">the petronics</a>' 
                        },
                        tooltip: {
