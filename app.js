import Embed from 'ember';
import Resolver from 'ember/resolver';
import loadInitializers from 'ember/load-initializer';
...
new Pretender(function(){
    this.get("./items", function() {
        var items = {
            items: [
                { id: 1, name: "Traditional", price: "50", image_url: "/images/burger-1.jpeg"},
...
Embed.MODEL_FACTORY_INJECTIONS = true;

App = Embed.Application.extends({
