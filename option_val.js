 ...
 */
 ...
 function insertFinLine(ln)
 {
        ...
        f.innerHTML ="<input type='hidden' name='fin_deleted[]' id='fin_deleted" + ln + "' value='0'><input type='button' class='form-submit' value='Remove Row' tabindex='116' onclick='markFinLineDeleted(" + ln +")'/><b>";
